...
' 2001/08/05 Used in Infinos
    ...
    Public Const BIF_NEWDIALOGSTYLE = &H40&     '2001/08/11, see e-mail from Mattias below...
    
    Public Const BIF_BROWSEFORCOMPUTER = &H1000
    Public Const BIF_BROWSEFORPRINTER = &H2000
    Public Const BIF_BROWSEINCLUDEFILES = &H4000

' 2001/08/07 From File: shlobj.h
...
'Larry,
'
'>Do you know how to use this flag?
'
'You use it like any other BIF_ flag. Declare the constant
'
'Const BIF_NEWDIALOGSTYLE = &H40&
'
'Then include it with any other BIF_ flags in BROWSEINFO.ulFlags.
'
'
'>And how do I call OleInitialize or CoInitialize ?
'
'You don 't have to, VB has done that for you already.
'
'
'mattias
'
