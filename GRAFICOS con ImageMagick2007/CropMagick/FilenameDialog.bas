...
Function SaveDialog(Form1 As Form, filter As String, Title As String, InitDir As String, Optional fname As String) As String
 ...
 Dim ofn As OPENFILENAME
    ...
    Else
        ofn.lpstrFile = InitDir & fname & Chr(0) & Space(255)
    End If
    ofn.nMaxFile = 255
    ...
    If (A) Then
        SaveDialog = left(ofn.lpstrFile, InStr(1, ofn.lpstrFile, Chr(0)) - 1)
    Else
        SaveDialog = ""
    End If
    'MsgBox Asc(Right(SaveDialog, 1))
End Function
