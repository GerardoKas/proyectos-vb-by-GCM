...
End If
If nt = "" Then Exit Sub
TheText.Text = TheText.Text & Trim(nt) & bar
...
MsgBox "Creado Por Gerardo Casrto Mtz. Desde 2006, en Vigo" & vbCrLf & "Ubicado nen : " & App.Path
End Sub
...
TheText.LoadFile filename, 1

DataTexto = DataTexto & "(...)" & vbCrLf & vbCrLf & "Titulo : " & vbCrLf & filename & vbCrLf & vbCrLf & TheText.Text

'TheText.Text = TheText.Text & vbCrLf & "(...)" & vbCrLf & "Titulo: " & filename & " vbcrlf & vbcrlf & TheText.LoadFile(filename)"
...
filename = getOpenFilename(cmdlg)
'TheText.Text =  openFile(filename)
TheText.LoadFile filename
...
tempName = filename
Else
tempName = "c:\TEMP\Paste_" & DateTime.Date$ & ".bak"
...
Debug.Print (xvbCrLf & Printer.DeviceName & vbCrLf & Printer.ColorMode _
...
If Data.GetFormat(vbCFFiles) Then
    ...
    Next
    TheText.Text = TheText.Text & ficheros & bar
...
ElseIf Data.GetFormat(vbCFText) Then
    TheText.Text = TheText.Text & Trim(Data.GetData(vbCFText)) & bar
ElseIf Data.GetFormat(vbCFRTF) = True Then
    TheText.Text = TheText.Text & Trim(Data.GetData(vbCFRTF)) & bar
