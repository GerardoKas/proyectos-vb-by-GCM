...
dialog.Filter = "Texto plano *.txt|*.txt|WordPad *.rtf|*.rtf|Pagina Web *.html|*.html|Todos los Archivos *.*|*.*"
dialog.FilterIndex = 1
dialog.DefaultExt = "nfo"
If savedir <> "" Then
...
Function getOpenFilename(dialog As CommonDialog)
On Error GoTo ErrName
dialog.Flags = cdlOFNNoValidate
dialog.CancelError = True 'genera error si se puelsa cancelar
dialog.Filter = "WordPad *.rtf|*.rtf|Texto plano *.txt|*.txt|Pagina Web *.html|*.html|Todos los Archivos *.*|*.*"
dialog.FilterIndex = 2
dialog.DefaultExt = "txt"
dialog.filename = dialog.filename
dialog.ShowOpen
getOpenFilename = dialog.filename
